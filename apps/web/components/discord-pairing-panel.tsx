    ...
    return (
      <Stagger className="h-full overflow-y-auto">
        <div className="mx-auto flex w-full max-w-lg flex-col gap-3 px-6 py-6">
          ...
          <motion.div
            variants={fadeUp}
            className="rounded-[8px] ring-1 ring-border bg-card"
          >
  ...
  return (
    <Stagger className="h-full overflow-y-auto">
      <div className="mx-auto flex w-full max-w-lg flex-col gap-3 px-6 py-6">
        ...
        {/* Invite bot */}
        <motion.div variants={fadeUp} className="flex items-center justify-between rounded-[8px] ring-1 ring-border bg-card px-3.5 py-3">
          <div>
