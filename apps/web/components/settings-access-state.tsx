...
export function SettingsAccessState() {
  return (
    <div
      className="rounded-[8px] border-2 border-border bg-card p-8 shadow-none"
    >
      <div className="flex max-w-md flex-col items-start gap-4">
        <div className="flex size-12 items-center justify-center rounded-[8px] border border-border bg-muted">
          <Gear
            size={22}
