      ...
      >
        ...
        <div className="rounded-xl border border-border bg-card p-6">
          <div className="flex items-center gap-4">
            <div className="flex size-10 items-center justify-center rounded-lg bg-[#5E6AD2]/10">
            ...
            <button className="rounded-lg bg-[#5E6AD2] px-4 py-2 text-sm font-medium text-white transition-colors hover:bg-[#5E6AD2]/90">
              Connect
            </button>
          </div>
        </div>
