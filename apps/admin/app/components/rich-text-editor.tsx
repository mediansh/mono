...
const editorContentClass = cn(
  ...
  "[&_em]:italic",
  "[&_code]:bg-sidebar-accent [&_code]:px-1 [&_code]:py-0.5 [&_code]:font-mono [&_code]:text-[12px]",
  "[&_pre]:my-3 [&_pre]:overflow-x-auto [&_pre]:bg-sidebar-accent [&_pre]:p-3 [&_pre]:font-mono [&_pre]:text-[12px]",
...
export function RichTextEditor({
  ...
  return (
    <div
      className={cn(
        "overflow-hidden border border-sidebar-border bg-background",
        className,
      )}
    >
