...
export default function AdminEarlyAccessPage() {
  ...
  return (
    ...
    >
      ...
      <motion.div
        variants={fadeUp}
        className="mb-5 flex items-center justify-between border border-sidebar-border bg-sidebar/30 p-4"
      >
        <div>
        ...
        <button
          ...
          className={`flex h-7 w-12 items-center p-0.5 transition-colors disabled:opacity-50 ${
            enabled ? "justify-end bg-primary" : "justify-start bg-muted"
          }`}
        >
          <span className="size-6 bg-background shadow" />
        </button>
      </motion.div>
      ...
      >
        ...
        <div className="flex flex-col gap-2 sm:flex-row">
          ...
          <input
            ...
            className="h-9 w-20 bg-background px-3 text-[13px] ring-1 ring-border outline-none focus:ring-foreground/30"
          />
          <button
            type="button"
