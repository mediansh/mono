  ...
  "tasks": [
    {
      ...
      "source": null,
      "sources": [],
      "customData": { "plan": "scale", "appVersion": "2.14.0" },
...
| `customData` | any \| null | Custom data attached when the task was created via [Submit feedback](/api/feedback-submit), or `null`. |
